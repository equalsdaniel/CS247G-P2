    ...
    public class SplineInstantiate : SplineComponent
    {
        ...
        Transform instancesRootTransform
        {
            get
            {
                ...
                {
                    m_InstancesRoot = new GameObject(
                        k_InstancesRootName + GetEntityId().GetHashCode());
        ...
        {
            if (m_Seed == 0)
                m_Seed = GetEntityId().GetHashCode();
        ...
        void CheckChildrenValidity()
        {
            ...
            var ids = GetComponents<SplineInstantiate>()
                .Select(sInstantiate => sInstantiate.GetEntityId().GetHashCode()).ToList();
