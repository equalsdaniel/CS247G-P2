...
namespace UnityEditor.Splines
{
    ...
    public static class SerializedPropertyUtility
    {
        ...
        {
            var hash = container.GetEntityId().GetHashCode();
        ...
        public static SerializedProperty GetSplineSerializedProperty(SerializedObject splineContainer, int splineIndex)
        {
            ...
            var hash = HashCode.Combine(
                splineContainer.targetObject.GetEntityId().GetHashCode(), splineIndex);
        ...
        {
            var hash = HashCode.Combine(
                splineProperty.serializedObject.targetObject.GetEntityId().GetHashCode(),
